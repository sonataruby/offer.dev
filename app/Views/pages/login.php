<?php echo view('App\Views\header',["title" => "Login Page"]); ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-body mb-3"><div class="row px-xl-5 px-sm-4 px-3">
              <div class="col-3 ms-auto px-1">
                <a class="btn btn-outline-light w-100" href="/loginfacebook">
              ...
              <div class="col-3 px-1">
                <a class="btn btn-outline-light w-100" href="/loginapple">
                  <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <div class="col-3 me-auto px-1">
                <a class="btn btn-outline-light w-100" href="/logingoogle">
                  <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <div class="card card-plain bg-white">
                ...
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder">Login Access</h4>
        ...
        <?php endif; ?>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    ...
                    <?php if ($config->allowRegistration) : ?>
                          <p class="mb-4 text-sm mx-auto"> Don't have an account? <a href="<?= route_to('register') ?>"><?=lang('Auth.needAnAccount')?></a></p>
                    <?php endif; ?>
          ...
          background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">Login Smart Dashboard</h4>
 ...
 <?php echo view('App\Views\footer',["components" => []]); ?>