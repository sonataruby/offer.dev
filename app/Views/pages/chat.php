                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="d-flex flex-column">
                            ...
                            <span class="text-xs">Click : <?php echo date("d-m h:i A",$item->created_at);?> | <?php echo $item->name;?> | Lead delay: <?php echo delay_timeago($item->timestart,$item->timelead);?></span>
                          </div>
                        </div>
                      </td>
