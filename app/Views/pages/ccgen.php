...
function ccgen(){
  init();
  $("#gerar").bind("click", function(){darkside(document.console.ccp.value,document.console.tr.value);});
  ...
  if(p1!="" && p1!=null){
    ...
    for(var k=1;k<=ccghm;k++){
      ...
      if(clcd && ccck){
        ...
        if(document.console.eccv.value=='' && document.console.ccvi.checked){
        ...
        else if(document.console.eccv.value!='' && document.console.ccvi.checked)var eccv=document.console.eccv.value;
        else var eccv='';
        if(jou==0){
          var out=out+=cdif;
...
<script type="text/javascript">
        $(document).ready(function(){
          ccgen();
          $("#CheckCCV").on("click", async function(){
            $("#testData").html("");
            var data = $("#output2").val().split(/\r?\n/);;
            for(var i=0;i<=data.length;i++){
              $("#testData").append("<div id='loadding"+i+"'>/api.php?cc="+data[i]+" Loadding....</div>");
              await axios.post("api.php",{cc : data[i]}).then(function (response) {
                  // handle success
                  $("loadding"+i).html(response);
                });
            }
          });
        });
      ...
      <div class="row">
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Gen Credit Info</h6>
              <hr>
            </div>
            <div class="card-body pt-4 p-3">
              ...
              <form name="console" id="console"  role="form" method="POST">
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Insert your BIN</label>
                  <input type="text" class="input_text form-control" id="ccpN" name="ccp" value=""  placeholder="xxxx xxxx xxxx xxxx" maxlength="19">
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-3">
                    <label for="inputPassword">Include</label>
                  </div>
                  <div class="col-3">
                  ...
                  <div class="col-3">
                    ...
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineCheckbox1">CCV2</label>
                    </div>
                  ...
                  <div class="col-3">
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineCheckbox1">Bank Info</label>
                    </div>
                  </div>
                </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-6">
                   <div class="row">
                     <label for="staticEmail" class="col-12 col-form-label">Amount</label>
                      <div class="col-12">
                        <input class="form-control" type="number" id="ccghm" name="ccghm" maxlength="4" value="100">
                      </div>
                    </div>
                </div>
                ...
                <div class="col-6">
                   <div class="row">
                     <label for="staticEmail" class="col-sm-12 col-form-label">Format</label>
                      <div class="col-sm-12">
                        <select name="ccoudatfmt" class="input_text form-select">
                            <option value="CHECKER" selected="selected">Text
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                   <div class="row">
                     <label for="staticEmail" class="col-sm-12 col-form-label">CCV2</label>
                      <div class="col-sm-12">
                        <input class="form-control" type="number" value="" id="eccv" name="eccv" maxlength="4">
                      </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                   <div class="row">
                     <label for="staticEmail" class="col-sm-12 col-form-label">Month</label>
                      <div class="col-sm-12">
                        <select name="emeses" class="input_text form-select">
                ...
                <div class="col-sm-4">
                   <div class="row">
                     <label for="staticEmail" class="col-sm-12 col-form-label">year</label>
                      <div class="col-sm-12">
                        <select name="eyear" class="input_text form-select">
                           <option value="rnd">Rnd
        ...
        <div class="row mb-3">
                ...
                <div class="col-sm-12">
                  ...
                  <a class="Lbutton btn btn-primary" name="gerar" id="gerar"><i class="fa fa-cog fa-spin"></i> Generate Cards</a> 

                    <button class="clean btn btn-primary" id="cleanText">Clear</button>
                    <a class="btn btn-primary" type="button" id="CheckCCV">Check</a>
                </div>
        </div>
        ...
        <div class="col-md-5 mt-4">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">Credit Automatic Make</h6>
                </div>
            ...
            <div class="card-body pt-4 p-3">
              <textarea class="textarea form-control" name="output2" id="output2" rows="15"></textarea>
              
            </div>
          </div>
        </div>
      </div>
      <div class="container" id="testData"></div>
    </div>
